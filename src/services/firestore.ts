...
let mockLocalUsers: UserProfile[] = [
  { uid: BOT_UID, name: 'Blue Bird (AI Assistant)', email: null, isBot: true, isVerified: true, isCreator: false, avatarUrl: 'outline-bird-avatar', lastSeen: { seconds: Math.floor(Date.now()/1000), nanoseconds: 0} as unknown as Timestamp},
  { uid: DEV_UID, name: 'Dev Team', email: 'devteam@example.com', isDevTeam: true, isVerified: true, isCreator: false, isVIP: true, vipPack: "Lifetime", avatarUrl: 'dev-team-svg-placeholder', createdAt: { seconds: Date.now()/1000, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000), nanoseconds: 0} as unknown as Timestamp },
  { uid: 'test-user', name: 'Test User', email: 'test@example.com', isVIP: false, isVerified: false, isCreator: false, avatarUrl: `https://picsum.photos/seed/test-user/200`, createdAt: { seconds: Date.now()/1000, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000), nanoseconds: 0} as unknown as Timestamp, selectedVerifiedContacts: [], hasMadeVipSelection: false },
  { uid: 'verified-contact-1', name: 'Twaha mizan', email: 'twahamizan04@gmail.com', isVerified: true, isVIP: false, vipPack: undefined, isCreator: false, avatarUrl: `https://picsum.photos/seed/twaha-the-great/200`, createdAt: { seconds: Date.now()/1000, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 1 * 60, nanoseconds: 0} as unknown as Timestamp, hasMadeVipSelection: true },
  ...
  { uid: 'regular-user-1', name: 'Ashadul', email: 'ashadul@example.com', isCreator: false, isVerified: true, avatarUrl: `https://picsum.photos/seed/ashadul-regular/200`, createdAt: { seconds: Date.now()/1000, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 30 * 60, nanoseconds: 0} as unknown as Timestamp },
  { uid: 'monk-user-1', name: 'Karim Ahmed', email: 'monk1@example.com', isCreator: false, isVIP: true, vipPack: 'Gold VIP', avatarUrl: `https://picsum.photos/seed/monk-peaceful/200`, createdAt: { seconds: Date.now()/1000, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 60*60*2, nanoseconds: 0} as unknown as Timestamp },
  { uid: 'monk-user-2', name: 'Sajid Islam', email: 'monk2@example.com', isCreator: false, avatarUrl: `https://picsum.photos/seed/monk-zen/200`, createdAt: { seconds: Date.now()/1000, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 60*60*3, nanoseconds: 0} as unknown as Timestamp },
  { uid: 'monk-user-3', name: 'Ayesha Siddika', email: 'monk3@example.com', isCreator: false, avatarUrl: `https://picsum.photos/seed/monk-silent/200`, createdAt: { seconds: Date.now()/1000, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 60*60*4, nanoseconds: 0} as unknown as Timestamp },
  { uid: 'monk-user-4', name: 'Fatima Akter', email: 'monk4@example.com', isCreator: false, avatarUrl: `https://picsum.photos/seed/monk-meditative/200`, createdAt: { seconds: Date.now()/1000, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 60*60*5, nanoseconds: 0} as unknown as Timestamp },
  ...
  { uid: 'verified-contact-3', name: 'Asad', email: 'asad@example.com', isVerified: true, isVIP: false, vipPack: undefined, isCreator: false, avatarUrl: `https://picsum.photos/seed/asad-verified/200`, createdAt: { seconds: Date.now()/1000, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 4 * 60, nanoseconds: 0} as unknown as Timestamp },
  { uid: 'verified-contact-4', name: 'Saidul', email: 'saidul@example.com', isVerified: true, isVIP: false, vipPack: undefined, isCreator: false, avatarUrl: `https://picsum.photos/seed/saidul-verified/200`, createdAt: { seconds: Date.now()/1000, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 15 * 60, nanoseconds: 0} as unknown as Timestamp },
  { uid: 'vip-user-2', name: 'Maria Oishee', email: 'maria@example.com', isVIP: false, vipPack: undefined, isCreator: false, isVerified: true, avatarUrl: `https://picsum.photos/seed/maria-oishee-new/200`, createdAt: { seconds: Date.now()/1000, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 1 * 60, nanoseconds: 0} as unknown as Timestamp, hasMadeVipSelection: true },
  { uid: 'vip-user-3', name: 'Rafi', email: 'rafi@example.com', isVIP: false, vipPack: undefined, isCreator: false, isVerified: true, avatarUrl: `https://picsum.photos/seed/rafi-developer/200`, createdAt: { seconds: Date.now()/1000, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 25 * 60, nanoseconds: 0} as unknown as Timestamp, hasMadeVipSelection: true },
  { uid: 'vip-only-user', name: 'Rahim Uddin', email: 'valerie@example.com', isVIP: true, vipPack: 'Bronze VIP', isCreator: false, isVerified: false, avatarUrl: `https://picsum.photos/seed/valerie-vip/200`, createdAt: { seconds: Date.now()/1000, nanoseconds: 0} as unknown as Timestamp, vipExpiryTimestamp: Date.now() + 5 * 24 * 60 * 60 * 1000, lastSeen: { seconds: Math.floor(Date.now()/1000) - 5 * 60, nanoseconds: 0} as unknown as Timestamp, hasMadeVipSelection: false },
  { uid: 'nayem-vip', name: 'Nayem', email: 'nayem@example.com', isVIP: false, vipPack: undefined, isCreator: false, isVerified: true, avatarUrl: `https://picsum.photos/seed/nayem-is-great/200`, createdAt: { seconds: Date.now()/1000 - 100, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 2 * 60, nanoseconds: 0} as unknown as Timestamp, hasMadeVipSelection: true },
  { uid: 'abdul-kaium-verified', name: 'Abdul-Kaium', email: 'abdulkaiumiqbel2005@gmail.com', isVerified: true, isVIP: false, vipPack: undefined, isDevTeam: false, isCreator: false, avatarUrl: `https://picsum.photos/seed/kaium-verified/200`, createdAt: { seconds: Date.now()/1000 - 200, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 8 * 60, nanoseconds: 0} as unknown as Timestamp },
  { uid: 'julker-nain-creator', name: 'Julker Nain', email: 'julker@example.com', isCreator: true, isVerified: true, isVIP: false, vipPack: undefined, avatarUrl: `https://picsum.photos/seed/julker-artist/200`, createdAt: { seconds: Date.now()/1000 - 250, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 3 * 60, nanoseconds: 0} as unknown as Timestamp, hasMadeVipSelection: false },
  { uid: 'al-amin-creator', name: 'Al-Amin', email: 'alamin@example.com', isCreator: true, isVerified: true, isVIP: false, vipPack: undefined, avatarUrl: `https://picsum.photos/seed/al-amin-creator/200`, createdAt: { seconds: Date.now()/1000 - 300, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 6 * 60, nanoseconds: 0} as unknown as Timestamp, hasMadeVipSelection: false },
  { uid: 'sakib-new-user', name: 'Sakib', email: 'sakib@example.com', isCreator: false, avatarUrl: `https://picsum.photos/seed/sakib-user/200`, createdAt: { seconds: Date.now()/1000 - 400, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 60*60*6, nanoseconds: 0} as unknown as Timestamp },
  { uid: 'walid-new-user', name: 'Walid', email: 'walid@example.com', isCreator: false, avatarUrl: `https://picsum.photos/seed/walid-user/200`, createdAt: { seconds: Date.now()/1000 - 410, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 60*60*7, nanoseconds: 0} as unknown as Timestamp, isVIP: true, vipPack: "Starter VIP" },
  { uid: 'samia-new-user', name: 'Samia', email: 'samia@example.com', isCreator: false, avatarUrl: `https://picsum.photos/seed/samia-user/200`, createdAt: { seconds: Date.now()/1000 - 420, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 60*60*8, nanoseconds: 0} as unknown as Timestamp },
  { uid: 'shamim-new-user', name: 'Shamim', email: 'shamim@example.com', isCreator: false, avatarUrl: `https://picsum.photos/seed/shamim-user/200`, createdAt: { seconds: Date.now()/1000 - 430, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 60*60*9, nanoseconds: 0} as unknown as Timestamp, isVIP: true, vipPack: "Micro VIP" },
  { uid: 'jubayer-new-user', name: 'Jubayer', email: 'jubaye@example.com', isCreator: false, avatarUrl: `https://picsum.photos/seed/jubaye-user/200`, createdAt: { seconds: Date.now()/1000 - 440, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 60*60*10, nanoseconds: 0} as unknown as Timestamp, isVIP: true, vipPack: "Silver VIP" },
  { uid: 'hadi-new-user', name: 'Hadi', email: 'hadi@example.com', isCreator: false, avatarUrl: `https://picsum.photos/seed/hadi-user/200`, createdAt: { seconds: Date.now()/1000 - 450, nanoseconds: 0} as unknown as Timestamp, lastSeen: { seconds: Math.floor(Date.now()/1000) - 60*60*11, nanoseconds: 0} as unknown as Timestamp },
];
...
let mockMessages: { [chatId: string]: Message[] } = {
    ...
    'chat-blue-bird': [
     ...
     'chat-twaha': [
        { id: 'm5-twaha', chatId: 'chat-twaha', senderId: 'test-user-placeholder', senderName: 'Test User', text: 'Hey Twaha, are we still on for tomorrow?', timestamp: { seconds: Date.now()/1000 - 600, nanoseconds: 0} as unknown as Timestamp, seenBy: ['verified-contact-1'] },
        { id: 'm6-twaha', chatId: 'chat-twaha', senderId: 'verified-contact-1', senderName: 'Twaha mizan', text: 'Yes, absolutely! 10 AM, right?', timestamp: { seconds: Date.now()/1000 - 500, nanoseconds: 0} as unknown as Timestamp, reactions: { '👍': { count: 1, users: ['test-user-placeholder'] } } },
        { id: 'm9-twaha', chatId: 'chat-twaha', senderId: 'test-user-placeholder', senderName: 'Test User', text: 'Excellent!', timestamp: { seconds: Date.now()/1000 - 200, nanoseconds: 0} as unknown as Timestamp },
    ],
    'chat-rakib': [
        { id: 'm8-rakib', chatId: 'chat-rakib', senderId: 'verified-contact-2', senderName: 'Rakib', text: 'Will do. They look good so far.', timestamp: { seconds: Date.now()/1000 - 350, nanoseconds: 0} as unknown as Timestamp },
    ],
    'chat-ashadul': [
        { id: 'm11-ashadul', chatId: 'chat-ashadul', senderId: 'test-user-placeholder', senderName: 'Test User', text: 'Almost, just a few more sections to wrap up.', timestamp: { seconds: Date.now()/1000 - 100, nanoseconds: 0} as unknown as Timestamp },
    ],
};
...
const notifyChatListListeners = () => {
    ...
    chatListListeners.forEach(listener => {
        try {
            listener([...enrichedChats]);
        } catch (e) {
...
export const getUserChats = (
  ...
  return () => {
    ...
    chatListListeners = chatListListeners.filter(cb => cb !== callback);
  };
};
...
export const sendMessage = async (
  ...
  if (chatIndex !== -1) {
    ...
    mockChats[chatIndex].lastMessage = lastMsgText;
  ...
  if (!isBotMessage && chatIndex !== -1) {
      ...
      const originalSenderIsUser = senderId !== BOT_UID;

      if (isBotChat && originalSenderIsUser && (trimmedText || attachmentUrl)) {
          let currentMessageTextForBot = trimmedText;
          let photoDataUriForBot: string | undefined = undefined;
          let audioDataUriForBot: string | undefined = undefined;

          if (attachmentType === 'image' && attachmentUrl) {
            photoDataUriForBot = attachmentUrl; // Pass the data URI of the image
            if (!trimmedText) currentMessageTextForBot = "[User sent an image]"; // If only image, provide context text
          } else if (attachmentType === 'audio' && attachmentUrl) {
            audioDataUriForBot = attachmentUrl;
            if (!trimmedText) currentMessageTextForBot = "[User sent an audio message]";
          } else if (attachmentType === 'video') {
            currentMessageTextForBot = trimmedText ? `${trimmedText} [User sent a video: ${attachmentName}]` : `[User sent a video: ${attachmentName}]`;
          } else if (attachmentType === 'document') {
            currentMessageTextForBot = trimmedText ? `${trimmedText} [User sent a document: ${attachmentName}]` : `[User sent a document: ${attachmentName}]`;
          }
          
          const historyForFlow = (mockMessages[chatId] || [])
            .slice(-6, -1) // Get up to 5 previous messages, excluding the current one just added
            .map(msg => ({
              role: msg.senderId === BOT_UID ? 'model' : 'user',
              text: msg.text || (msg.attachmentUrl ? `[Attachment: ${msg.attachmentName || msg.attachmentType}]` : ""),
            })) as BlueBirdAssistantInput['chatHistory'];
          ...
          setTimeout(async () => {
              try {
                  ...
                  try {
                      await sendMessage(chatId, BOT_UID, "I'm having a little trouble thinking right now. Please try again later!", undefined, undefined, true);
                  } catch (fallbackError) {
                      console.error("[sendMessage] Error sending bot's fallback message:", fallbackError);
                  }
              }
