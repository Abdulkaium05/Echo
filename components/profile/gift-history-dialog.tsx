    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md flex flex-col h-[70vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            A log of all the wonderful gifts you've received.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="px-6">
              {isLoading ? (
                ...
                <div className="space-y-3">
                  {gifts.map((gift) => {
                    const BadgeIcon = gift.badgeType ? badgeComponentMap[gift.badgeType] : Gift;
                        ...
                        <div className="relative">
                            <Avatar className="h-10 w-10">
                             ...
                             <div className="absolute -bottom-1 -right-1 bg-background p-0.5 rounded-full shadow">
                                <BadgeIcon className={cn("h-4 w-4", gift.giftType === 'points' && "text-yellow-500")} />
                             </div>
                        </div>
